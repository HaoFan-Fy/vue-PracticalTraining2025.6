        ...
        <el-table-column label="操作" width="380" fixed="right">
          <template #default="scope">
            <div style="white-space: nowrap;">
              <el-button v-if="hasPermission('system:user:edit')" type="primary" size="small" @click="handleEdit(scope.row)">编辑</el-button>
              <el-button v-if="hasPermission('system:user:edit')" type="warning" size="small" @click="handleAssignRole(scope.row)">分配角色</el-button>
              <el-button v-if="hasPermission('system:user:delete')" type="danger" size="small" @click="handleDelete(scope.row)">删除</el-button>
              <el-button v-if="hasPermission('system:user:edit')" type="info" size="small" @click="handleResetPassword(scope.row)">重置密码</el-button>
            </div>
          </template>
        </el-table-column>
      </el-table>
