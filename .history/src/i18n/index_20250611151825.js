...
const zh = {
  ...
  home: {
    ...
    fromLastMonth: '较上月',
    salesTrend: '销售趋势',
    revenueExpense: '收入支出对比',
    productSales: '产品销售分布',
    customerRegion: '客户地区分布'
  },
  common: {
    confirm: '确定',
    cancel: '取消',
...
const en = {
  ...
  home: {
    ...
    businessAnalysis: 'Business Data Analysis',
    ...
    revenueExpense: 'Revenue vs Expense',
    productSales: 'Product Sales Distribution',
    customerRegion: 'Customer Regional Distribution'
  },
  common: {
    confirm: 'Confirm',
    cancel: 'Cancel',
